...
# 
# temp_rast<-terra::rast(paste0(onedrive_wd,"/raster/raster_temp_summer.tif"))
# 
# bc_sf <- bcmaps::bc_bound() |>
#   st_transform(crs(cmidata)) 
# 
# bc_vect <- vect(bc_sf)
# 
# 
...
# 
# 
# named_wbs<-read_rds(paste0(onedrive_wd,"/named_lakes_and_rivers_merged.rds"))
# 
# bc_temp<- temp_rast |>
#   crop(bc_vect) |>
#   mask(bc_vect)
# 
# p1<-ggplot() +
#   geom_spatraster(data = bc_temp[[1]]) +
#   scale_fill_viridis_c(na.value = "transparent") +
#   labs(fill = names(bc_temp[[1]])) +
#   theme_minimal()
# 
# # bc_temp<- temp_rast |>
# #   crop(named_wbs) |>
...
# 
# 
# ggsave("./output/annual_temp_bc.png",p1, height = 8, width=6, dpi = 400)

#hydroclim_data<-read_sf(paste0(onedrive_wd,"/raster/"))
