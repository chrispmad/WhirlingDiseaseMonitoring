...
wb_list = wb_list |> 
  dplyr::select(GNIS_NA:days_fished_kmeans_bin,fish_edna_positive_in_watershed:active_water_authorizations,active_water_authorizations_kmeans_bin:tubifex_habitat_suitability,known_fish,sus_spp:priority)
```
