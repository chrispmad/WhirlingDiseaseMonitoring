...
i. Bin watercraft inspections of watercraft coming from infected areas with natural breaks into low/med/high that are tied to waterbodies
...
```
			...
			ii. Watercraft inspections going to and coming from specific WBs inside BC that had positive WD results - look at destination wbs, those are automatically high priority
