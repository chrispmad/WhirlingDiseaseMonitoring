...
sara <-sf::st_read(paste0(onedrive_wd,"DFO_SARA/dfo_sara_occurrences_in_BC_no_marine.gpkg"))

sara <- sf::st_transform(sara, st_crs(wb_list))
wb_list$SARA<-NA

test<-st_join(wb_list, sara)
