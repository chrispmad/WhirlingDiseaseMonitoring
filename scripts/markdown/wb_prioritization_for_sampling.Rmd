...
DT::datatable(mines |> sf::st_drop_geometry() |> dplyr::slice(1:10))
...
DT::datatable(reccies |> sf::st_drop_geometry() |> dplyr::slice(1:10))
...
parks_nearby = parks |> 
  ...
  sf::st_join(wb_list |> dplyr::select(GNIS_NA, WATERSH)) |> 
  sf::st_drop_geometry() |> 
  dplyr::count(GNIS_NA, WATERSH, name = "parks_nearby")
