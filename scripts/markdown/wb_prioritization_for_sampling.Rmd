...
tubifex_maxent<- terra::rast("output/habitat_maxent_tubifex_fc.LQ_rm.3.tif")
...
maxent_rast<-terra::rast("output/habitat_maxent_tubifex_fc.LQ_rm.3.tif")

if(!interactive()){
ggplot() +
  tidyterra::geom_spatraster(data = maxent_rast, aes(fill = fc.LQ_rm.3))+
...
# Name the layers
names(all_r) = c("DO","DOCarbon","Phos","Nitr","Temp","Turb")
