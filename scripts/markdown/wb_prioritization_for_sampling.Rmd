...
wb_list = wb_list |> 
  dplyr::mutate(tib = as.numeric(TotalInspections_kmeans_bin),
                iwbc = as.numeric(insp_from_wd_bc_wb_b),
...
openxlsx::saveWorkbook(my_wb, paste0("output/Whirling_Disease_priorities_for_waterbody_sampling_",Sys.Date(),".xlsx"))
```
...
leaflet() |> 
  ...
  addLayersControl(
    ...
    overlayGroups = c("adjacent","infectable","infected",
