...
popup_tbls = leafpop::popupTable(
  wbs_new |> 
    ...
    dplyr::select(`Waterbody Name`,
                  ...
                  `Model Ranking`,
                  sampled_2024,
                  `Identified by FN partners`:SARA,
                  `WLRS AEB Provincial Fisheries Priority Ranking (1-20)`:`Other WLRS monitoring occurring in 2025? Y/N (potential site for eDNA sampling)`)
)
