...
popup_tbls = leafpop::popupTable(
  d_with_geometries |> 
    ...
    dplyr::select(`Waterbody Name`,
                  ...
                  `WLRS AEB Provincial Fisheries Priority Ranking (1-20)`:`Other WLRS monitoring occurring in 2025? Y/N (potential site for eDNA sampling)`,`Susceptible salmon species present (Y/N/Unknown`)
)
