...
knitr::opts_knit$set(root.dir = 'C:/Users/CMADSEN/Downloads/LocalR/long_term_projects/WhirlingDiseaseMonitoring/')
...
if(!file.exists('data/bc_stream_summary_stats.xlsx')){
  ...
  summary_stats = readxl::read_excel('data/bc_stream_summary_stats.xlsx')
}
...
# Filter for BC.
all_watersheds_s = sf::st_intersection(all_watersheds_s, bc)
